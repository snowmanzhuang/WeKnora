export default {
  ...
  agent: {
    ...
    editor: {
      ...
      fallbackModelDesc: 'Switches automatically when the primary model is unavailable and no answer has been emitted. Manage API credentials in Model Settings.',
      fallbackModelPlaceholder: 'Optional: select a fallback model',
      fallbackModelSameAsPrimary: 'The fallback model must differ from the primary model',
  ...
  createChat: {
    title: 'Hi, Welcome to use — your knowledge, within reach',
...
\
  ...
  agentStream: {
    ...
    tools: {
      ...
      researchDifferentials: 'Parallel Differential Research',
      differentialSubagent: 'Differential Research Subagent',
    ...
    toolStatus: {
      ...
      differentialResearchRunning: 'Researching {count} differential directions in parallel...',
      differentialResearchDone: 'Completed {completed}/{count} directions and selected {images} reference image(s)',
      differentialSubagentRunning: 'Researching: {diagnosis}',
      differentialSubagentDone: '{diagnosis}: evidence and image research complete',
      differentialSubagentNoImage: '{diagnosis}: evidence complete; no reliable image found',
      differentialSubagentNoMatch: '{diagnosis}: insufficient relevant evidence found',
      differentialSubagentFailed: '{diagnosis}: subagent failed',
  ...
  agentEditor: {
    ...
    imageUpload: {
      ...
      auxiliaryPreanalysisLabel: 'Enable Auxiliary VLM Pre-analysis',
      auxiliaryPreanalysisDesc: 'Smart Reasoning only: the auxiliary VLM first creates an ophthalmology image report, then the main model reads both the original image and that report before ReAct and knowledge retrieval. Adds one model call and extra latency.',
      auxiliaryPreanalysisVisionRequired: 'The main conversation model must have vision support enabled to use auxiliary VLM pre-analysis',
      differentialSubagentsLabel: 'Enable Parallel Differential Subagents',
      differentialSubagentsDesc: 'For Smart Reasoning image questions: after the main model selects 2–5 differential directions, isolated workers concurrently retrieve evidence and matching reference images before final synthesis.',
      differentialSubagentModel: 'Subagent Model',
      differentialSubagentModelDesc: 'Summarizes each independently retrieved differential. Prefer a fast, cost-efficient model; leave empty to reuse the main model.',
      differentialSubagentModelPlaceholder: 'Use the main model when empty',
      differentialSubagentConcurrency: 'Maximum Concurrent Subagents',
      differentialSubagentConcurrencyDesc: 'Choose 1–5. The backend always enforces a hard maximum of five concurrent workers.',
