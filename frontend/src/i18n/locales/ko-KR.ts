export default {
  ...
  agentStream: {
    ...
    tools: {
      ...
      researchDifferentials: '병렬 감별 진단 연구',
      differentialSubagent: '감별 진단 검색 서브에이전트',
    ...
    toolStatus: {
      ...
      differentialResearchRunning: '{count}개 감별 방향을 병렬 연구 중...',
      differentialResearchDone: '{completed}/{count}개 완료, 참고 이미지 {images}개 선택',
      differentialSubagentRunning: '검색 중: {diagnosis}',
      differentialSubagentDone: '{diagnosis}: 근거 및 이미지 검색 완료',
      differentialSubagentNoImage: '{diagnosis}: 근거 완료, 신뢰할 이미지 없음',
      differentialSubagentNoMatch: '{diagnosis}: 관련 근거 부족',
      differentialSubagentFailed: '{diagnosis}: 서브에이전트 실패',
  ...
  agentEditor: {
    ...
    imageUpload: {
      ...
      auxiliaryPreanalysisLabel: '보조 VLM 사전 분석 사용',
      auxiliaryPreanalysisDesc: '스마트 추론 전용: 보조 VLM이 먼저 구조화된 보고서를 생성하고, 주 모델은 원본 이미지와 이 보고서를 함께 받아 ReAct 및 지식베이스 검색을 수행합니다. 모델 호출과 지연 시간이 한 번 더 추가됩니다.',
      auxiliaryPreanalysisVisionRequired: '이 기능을 사용하려면 주 언어 모델이 이미지 입력을 지원해야 합니다',
      differentialSubagentsLabel: '병렬 감별 진단 서브에이전트 사용',
      differentialSubagentsDesc: '스마트 추론 이미지 질문에서 주 모델이 2–5개 감별 방향을 정하면 각 방향의 근거와 참고 영상을 병렬로 검색합니다.',
      differentialSubagentModel: '서브에이전트 모델',
      differentialSubagentModelDesc: '각 감별 방향의 독립 검색 결과를 요약합니다. 비워 두면 주 모델을 사용합니다.',
      differentialSubagentModelPlaceholder: '비워 두면 주 모델 사용',
      differentialSubagentConcurrency: '최대 동시 서브에이전트 수',
      differentialSubagentConcurrencyDesc: '1–5로 설정할 수 있으며 서버는 최대 5개로 제한합니다.',
