...
type AgentConfig struct {
	...
	AuxiliaryVLMPreanalysisEnabled      bool                      `json:"auxiliary_vlm_preanalysis_enabled"`
	DifferentialSubagentsEnabled        bool                      `json:"differential_subagents_enabled"`
	DifferentialSubagentModelID         string                    `json:"differential_subagent_model_id,omitempty"`
